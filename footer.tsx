  ...
  return (
    <footer className="bg-white pt-16 pb-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-stretch space-y-12">
          {/* Logo and Buttons Section */}
          <div className="flex flex-col sm:flex-row justify-center gap-8 sm:gap-8">
            {/* Logo */}
            <a href="#home" className="flex-shrink-0 sm:mr-auto">
              <Image
